...
import Seperator from "./ui/ScrollReveal";
    ...
    return (
        <footer className="footer">
             <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32 2xl:max-w-[1600px]">
                    <div className="space-y-4 xl:grid-cols-2 xl:gap-8">
                    ...
                    <div className="mt-15 xl:grid xl:grid-cols-4 xl:gap-8">
                    <scrollReveal animation="fadeUp" className="space-y-4">
                            ...
                            <p className="footer-description justify-self-center text-center md:justify-self-auto md:text-left">
                               Premium coffee beans, roaseted to order and shipped fresh. From our roastery to your cup since 2012.
                            </p> 
