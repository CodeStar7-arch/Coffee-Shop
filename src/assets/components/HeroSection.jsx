...
import heroBeans from "../assests/hero-beans.png";
        ...
        <>
            ...
            <div id="home" className="hero-text-column">
                ...
                <motion.div
                    ...
                    className="shadow-lg"
                    onClick={() =>
                    document.getElementById("shop")?Badge.scrollIntoView({ behavior: "smooth" })
                    }>
                    SHOP COFFEE ☕
                    </Button>
                    ...
                    size="lg"
                    onClick={() => 
                    document.getElementById("about")?Badge.scrollIntoView({ behavior: "smooth" })}>
                    OUR STORY
