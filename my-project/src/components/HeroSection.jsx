...
const heroBeans = "/images/hero-beans.png";
  ...
  return (
    <>
      ...
      <div id="home" className="hero-text-column">
        ...
        >
          Farm-to-cup single-origin beans sourced from Ethiopia,
          Colombia, Guatemala, Brazil, and beyond. Freshly roasted in
          small batches and delivered to your door within 48 hours for
          maximum freshness.
        </motion.p>
      ...
      <div className="hero-art-container">
        ...
        >
          <span className="hero-floating-badge-label">
            FROM
          </span>

          <span className="hero-floating-badge-price">
            $14.99
          </span>
